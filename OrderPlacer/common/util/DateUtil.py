...
class DateUtil:
    ...
    def curYmdInt(zoneStr: str = None) -> int:
        ...
        """
        return int(DateUtil.curYmd(zoneStr=zoneStr))
    ...
    def curHmsInt(zoneStr: str = None) -> int:
        ...
        """
        return int(DateUtil.curHms(zoneStr=zoneStr))
    ...
    @staticmethod
    def fmtTimestamp(ts: int, fmt: str, zoneStr: str = None) -> str:
        """
        Format timestamp
        :param ts: Timestamp
        :param fmt: Time format
...
if __name__ == '__main__':
    ...
    print(DateUtil.nowString('%Y-%m-%d %H:%M:%S', 'Asia/Shanghai'))
